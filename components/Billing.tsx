...
import { PrinterIcon, CheckCircleIcon, PdfIcon, FileTextIcon, ReceiptIcon } from './Icons';
...
const Billing: React.FC = () => {
    ...
    return (
        <div className="p-6 md:p-8">
            <h1 className="text-3xl font-bold text-slate-800 mb-4 dark:text-slate-200">Billing</h1>
                        ...
                        filteredItems.length > 0 ? (
                            activeTab === 'invoices' ? (
                             ...
                             <div className="text-center py-16">
                                <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200">No {activeTab === 'invoices' ? 'Invoices' : 'Receipts'} Found</h3>
                                <p className="text-slate-500 mt-2 dark:text-slate-400">Your search and filter combination did not return any results.</p>
                            </div>
                        )
                    ) : (
                        <div className="text-center py-16">
                            <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200">No billing records yet</h3>
                            <p className="text-slate-500 mt-2 dark:text-slate-400">Place an order from the Customers tab to generate an invoice.</p>
                        </div>
                    )}
                </div>
            </div>
                ...
                <Modal 
                    ...
                    footer={
                        <>
                            ...
                            <button type="button" onClick={handleCloseModal} className="bg-slate-200 text-slate-800 font-semibold py-2 px-4 rounded-lg shadow-sm hover:bg-slate-300 transition-colors dark:bg-slate-600 dark:text-slate-200 dark:hover:bg-slate-500">
                                Close
                            </button>
