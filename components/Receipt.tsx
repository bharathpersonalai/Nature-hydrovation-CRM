    ...
    <>
      <style>{`
        @media print {
          ...
          #receipt-section-content, #receipt-section-content * {
            visibility: visible;
          }
      ...
      <div id="receipt-section-content" className="text-slate-800 dark:text-slate-200">
        ...
        <section className="flex justify-between mt-8">
          <div>
            <h3 className="text-sm font-semibold uppercase text-slate-500 dark:text-slate-400 tracking-wider">Paid By</h3>
          ...
          <div className="text-right">
            ...
            <div>
              ...
              <span className="mt-1 inline-block px-3 py-1 text-xs font-bold rounded-full bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300">
                Paid in Full
              </span>
            </div>
          </div>
        ...
        {referralCode && (
            <div className="mt-8 p-4 text-center rounded-lg" style={{ border: `2px dashed ${brandingSettings.brandColor}`}}>
                <h3 className="font-bold text-lg" style={{ color: brandingSettings.brandColor }}>Refer Friends & Earn!</h3>
                <p className="text-slate-600 dark:text-slate-300 mt-1">Share your unique code to earn rewards:</p>
